                        ...
                        [
                            ...
                            [
                                new AppendablePropertyItem(TextAnimatorSelectorSelectorId, LanguageResourceDictionary.ResourceKeys.TextProperty_TextAnimator_Animator_Selector_Selector, () =>
                                    ...
                                    [
                                        new DoubleProperty(TextAnimatorSelectorBeginId, LanguageResourceDictionary.ResourceKeys.TextProperty_TextAnimator_Animator_Selector_Begin, 0.0, -100.0, 100.0, digit: 3, unitKey: LanguageResourceDictionary.ResourceKeys.Unit_Percent),
                                        new DoubleProperty(TextAnimatorSelectorEndId, LanguageResourceDictionary.ResourceKeys.TextProperty_TextAnimator_Animator_Selector_End, 100.0, -100.0, 100.0, digit: 3, unitKey: LanguageResourceDictionary.ResourceKeys.Unit_Percent),
                                        new DoubleProperty(TextAnimatorSelectorOffsetId, LanguageResourceDictionary.ResourceKeys.TextProperty_TextAnimator_Animator_Selector_Offset, 0.0, -100.0, 100.0, digit: 3, unitKey: LanguageResourceDictionary.ResourceKeys.Unit_Percent),
