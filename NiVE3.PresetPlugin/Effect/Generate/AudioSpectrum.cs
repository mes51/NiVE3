    ...
    public sealed class AudioSpectrum : IEffect
    {
        ...
        public PropertyBase[] GetProperties(Int32Size sourceSize)
        {
            ...
            [
                ...
                new Vector3dProperty(PropertyBeginPointId, LanguageResourceDictionary.ResourceKeys.Generate_AudioSpectrum_BeginPoint, center - new Vector3d(center.X, 0.0, 0.0) * 0.5, digit: 2),
                new Vector3dProperty(PropertyEndPointId, LanguageResourceDictionary.ResourceKeys.Generate_AudioSpectrum_BeginPoint, center + new Vector3d(center.X, 0.0, 0.0) * 0.5, digit: 2),
