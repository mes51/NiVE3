...
{
    [EffectMetadata(LanguageResourceDictionary.Noise_MedianLegacy_Name, "mes51", DefaultLanguageResourceNames.EffectCategory_Noise, LanguageResourceDictionary.Noise_MedianLegacy_Description, ID, LanguageResourceDictionaryType = typeof(LanguageResourceDictionary))]
    [Export(typeof(IEffect))]
    public sealed class MedianLegacy : IEffect
    {
        ...
        public PropertyBase[] GetProperties(Int32Size sourceSize)
        {
            return
            [
                new DoubleProperty(PropertyRadiusId, LanguageResourceDictionary.ResourceKeys.Noise_MedianLegacy_Radius, 0.0, 0.0, 300.0, digit: 0),
                new CheckBoxProperty(PropertyApplyToAlphaId, LanguageResourceDictionary.ResourceKeys.Noise_MedianLegacy_ApplyToAlpha, false)
            ];
        }
