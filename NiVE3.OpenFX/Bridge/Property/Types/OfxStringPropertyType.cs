...
{
    public class OfxStringPropertyType : IPropertyType
    {
        static readonly byte[] EmptyHashBase = [];

        public static readonly OfxStringPropertyType Instance = new OfxStringPropertyType();
