...
#pragma warning restore IDE0040
        ...
        public readonly Vector128<float> ToRgbVector128()
        {
            ...
            return new Xyz((float)(f(x) * D65X), (float)(f(y) * D65Y), (float)(f(z) * D65Z)).ToRgbVector128();
        }
        ...
        // http://www.brucelindbloom.com/index.html?Eqn_RGB_XYZ_Matrix.html
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Lab FromRgb(in Vector4 color)
        {
        ...
        // http://www.brucelindbloom.com/index.html?Eqn_RGB_XYZ_Matrix.html
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Lab FromRgb(in Vector128<float> color)
        {
            const double Kappa = 24389.0 / 27.0 / 116.0;
