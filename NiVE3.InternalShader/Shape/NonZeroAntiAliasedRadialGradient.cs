...
namespace NiVE3.InternalShader.Shape
{
    ...
    readonly partial struct NonZeroAntiAliasedRadialGradient(
    ...
    ) : IComputeShader
    {
        ...
        public void Execute()
        {
            ...
            if (area > 0.0F)
            {
                ...
                image[pos] = BlendMethods.Process(blendMode, image[pos], new Float4(CalcColor(gradientPos), CalcOpacity(gradientPos) * area));
            }
        }
